...
// Function for making the Image, Song Name, Artist Name and song dynamic
...
// Updating Song Duration and Current Time
...
for (let i = 0; i < allMusic.length; i++) {
  ...
  let liAudioTag = wrapper.querySelector(`.${allMusic[i].src}`);
  let liAudioDuration = wrapper.querySelector(`#${allMusic[i].src}`);
